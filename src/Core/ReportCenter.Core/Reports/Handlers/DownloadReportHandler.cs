...
public class DownloadReportHandler : IRequestHandler<DownloadReportQuery, Stream?>
{
    ...
    public async Task<Stream?> Handle(DownloadReportQuery request, CancellationToken cancellationToken)
    {
        ...
        return await _storageService.OpenReadAsync(report.FullFileName, cancellationToken);
    }
}
