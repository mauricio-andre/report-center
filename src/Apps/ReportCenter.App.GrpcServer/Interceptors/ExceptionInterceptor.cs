...
using ReportCenter.App.GrpcServer.Extensions;
...
namespace ReportCenter.App.GrpcServer.Interceptors;

public class ExceptionInterceptor : Interceptor
{
    private readonly IStringLocalizer<ReportCenterResource> _stringLocalizer;

    public ExceptionInterceptor(IStringLocalizer<ReportCenterResource> stringLocalizer)
    {
